      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          ...
          <p className="text-xl font-normal text-base leading-6 text-gray-400 ">
            ...
            ekscytującej dyscypliny. Nasza historia z paintballem sięga daleko
            wstecz, a nasza pasja do tego sportu stale rośnie.{" "}
          </p>
        </div>
        ...
        <div className="w-full bg-gray-100 px-10 pt-10 rounded-xl">
          <div className="container mx-auto">
            ...
            <div className="container mx-auto flex justify-center items-center">
              <img className="h-16 w-16 grayscale mb-6" src="./logosm.png" />
            </div>
          </div>
        </div>
      </div>
